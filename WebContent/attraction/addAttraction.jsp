...
<html>
<head>
  <script type ="text/javascript" src ="/SaltProject/resources/js/validation.js"></script>
  <meta charset="UTF-8">
...
<script type="text/javascript" src="/SaltProject/resources/JS/validation_addAttraction.js"></script>  
</head>
<body>
  <jsp:include page="/menu.jsp"/>

<div class="a_box">
	<form name ="newAttraction" action="/SaltProject/attraction/processAddAttraction.jsp" class="form-horizontal" method="post" enctype="multipart/form-data">
	  	<h1>어트랙션 등록</h1>
